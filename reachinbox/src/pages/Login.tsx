  ...
  return (
    <div className='bg-black max-w-[1440px] h-screen m-auto text-white  flex flex-col justify-between'>
        <div className=" w-full h-16 flex justify-center items-center border border-slate-800">
            <img src="https://cutshort.io/_next/image?url=https%3A%2F%2Fcdnv2.cutshort.io%2Fcompany-static%2F65fd8656038bd7002a27e9a7%2Fuser_uploaded_data%2Flogos%2Freachinbox_ai_logo.jpeg&w=256&q=75" alt="reachinbox-logo" className="h-7" />
        </div>
        ...
        <div className=" w-full h-8 flex justify-center items-center border border-slate-800">
            <p className='h-5 text-gray-600 text-xs'> ©️ 2024 Bhanu Prasad Reachinbox. All rights reserved.</p>
        </div>
    </div>
